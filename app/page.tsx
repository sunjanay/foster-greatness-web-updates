...
function ContactSection() {
  ...
  return (
    <motion.section
      ...
      className="mt-10 md:mt-12"
    >
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-fg-navy via-fg-navy to-fg-teal">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-fg-teal/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="relative grid md:grid-cols-2 gap-8 p-8 md:p-12">
          ...
          <motion.div variants={itemVariants} className="flex flex-col justify-center">
            ...
            <p className="text-white/80 text-lg mb-8 leading-relaxed">
              Whether you're a foster youth looking for community, an ally wanting to support, or an organization seeking partnership—we're here to help.
            </p>

            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                  <Heart className="w-5 h-5 text-fg-coral" />
                </div>
                <span className="text-white/90">Community-first approach</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                  <Link2 className="w-5 h-5 text-fg-teal" />
                </div>
                <span className="text-white/90">Meaningful connections</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="https://www.tiktok.com/@foster.greatness"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
                  aria-label="TikTok"
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=61553436033848"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
                  aria-label="Facebook"
          ...
          >
            <div data-tf-live="01KAF384A3ZB71SN3JRSRCSWAD" className="min-h-[400px]"></div>
          </motion.div>
        </div>
      </div>
    </motion.section>
